...
public class Addproductc {
    ...
    private ProductManagement.Product currentProduct;
    ...
    public void the_owner_updates_the_product_with_the_following_details_for_non_existing_product(io.cucumber.datatable.DataTable dataTable) {
        try {
            List<Map<String, String>> rows = dataTable.asMaps(String.class, String.class);
            int id = 0, quantity = 0;
            String name = null, description = null;
            ...
            assertTrue(ex.getMessage().contains("Cannot update. Product with ID: " + currentProduct.getId() + " does not exist."));
        }
    }
    ...
    public void the_user_tries_to_add_a_product_with_the_following_missing_details(io.cucumber.datatable.DataTable dataTable) {
        try {
            List<Map<String, String>> rows = dataTable.asMaps(String.class, String.class);
            int id = 0, quantity = 0;
            String name = null, description = null;
    ...
    public void the_user_tries_to_add_a_product_with_the_following_invalid_details(io.cucumber.datatable.DataTable dataTable) {
        try {
            List<Map<String, String>> rows = dataTable.asMaps(String.class, String.class);
            int id = 0, quantity = 0;
            String name = null, description = null;
    ...
    public void the_user_tries_to_add_a_product_with_the_following_details_and_dublicate_id(io.cucumber.datatable.DataTable dataTable) {
        try {
            List<Map<String, String>> rows = dataTable.asMaps(String.class, String.class);
            int id = 0, quantity = 0;
            String name = null, description = null;
            ...
            assertTrue(ex instanceof IllegalStateException);
            assertTrue(ex.getMessage().contains("Product with ID: " + currentProduct.getId() + " already exists."));
        }
    }
