...
Feature: Purchase desserts directly from store owners
  ...
  Scenario Outline: Purchase dessert with different details
    ...
    Examples:
      ...
      | Apple Pie       | 4.00  | Out of Stock | Dessert is out of stock              | desserts_page |
  ...
  Scenario Outline: Attempt to purchase dessert with dietary restrictions
    ...
    Examples:
      ...
      | 2      | user2     | user2@mail.com | 0597654321 | 22  | password2 | Gluten-Free  |               | Apple Pie     | 4.00  | Out of Stock |                  | Dessert is out of stock              | desserts_page |
      ...
      | 4      | user4     | user4@mail.com | 0591234321 | 24  | password4 |              | Dairy         | Chocolate Cake| 5.00  | In Stock     |                  | Dessert may contain allergens (Dairy)| desserts_page |
